		...
		<div class="row">
			<form method="post" action="">
				<table class="table table-striped" style="text-align: center; border: 1px;">
					<thead>
						<tr>
							<th id="formtitle" colspan="1" style="background-color: #eeeeee; text-align: center;">자유게시판 답변 작성</th>
						</tr> 
					</thead>
					...
					<tr>
						...
						<tr>
							<td>
							<textarea class="form-control" placeholder="글 내용을 입력해주세요." maxlength="2048" style="height: 330px"></textarea>
							</td>
						</tr>
					</tbody>
