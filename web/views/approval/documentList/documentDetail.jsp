...
<jsp:include page="/views/main/mainPage.jsp"/>
	...
	<table class="detailDoc">
		...
		<tr>
			...
			<td class="content"><input type="text" name="num" value="휴가계획서"></td>
		...
		<tr>
			<td class="td">문서번호</td>
			<td class="content" colspan="2"><input type="text" name="docNum" value="<%=d.getManagedocno()%>"></td>
			<!--value=document.getManageDocNo()-->
			<td class="td">사원번호</td>
			<td class="content" colspan="3"><input type="text" name="empNum" value="<%=d.getManageempid()%>"></td>
	...
	<table class="detailDoc">
		...
		<tr>
			<td class="td">분류<input type="hidden" name="va" value="va"></td>
			<td class="content"><input type="text" name="num" value="재직증명서"></td>
			<td rowspan="2" class="gap"></td>
			<td class="td" rowspan="3">결<br>재</td>
			<td class="td">1차 결재 확인</td>
			<td class="td">2차 결재 확인</td>
		...
		<!--이미지 태그넣기  -->
			<td class="td">첨부파일</td>
			<td class="content">&nbsp;<img id="titleImg" src="<%= request.getContextPath()%>/approvalUpload/<%= img.getChangeName()%>"></td>
			<td class="approvalTd" rowspan="2"><input type="text" name="approve1"></td>
			<td class="approvalTd" rowspan="2"><input type="text" name="approve2"></td>
			<td class="approvalTd" rowspan="2"><input type="text" name="approve3"></td>
		</tr>
	...
	<table class="detailDoc">
		...
		<tr>
			<td class="td">분류<input type="hidden" name="va" value="va"></td>
			<td class="content"><input type="text" name="num" value="업무계획서"></td>
			<td rowspan="2" class="gap"></td>
			<td class="td" rowspan="3">결<br>재</td>
			<td class="td">1차 결재 확인</td>
			<td class="td">2차 결재 확인</td>
