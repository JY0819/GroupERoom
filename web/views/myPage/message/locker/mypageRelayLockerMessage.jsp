...
<section class="content">
	...
	<form id="formId" action="<%=request.getContextPath()%>/sendLockerMsg" method="post">
			...
			<div align="center" id="alignDiv">
				<table>
					<tr>
						...
						<td colspan="4">
							<input id="btn2" type="button" value="돌아가기" onclick="location.href='<%=request.getContextPath()%>/myPageMessageLockerDetail?msgno=<%= msg.getMsgNo()%>'">
						</td>
					</tr>
					<tr>
						<td>받는 사람</td>
