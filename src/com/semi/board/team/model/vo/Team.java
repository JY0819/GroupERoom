package com.semi.board.team.model.vo;
...
public class Team {
	...
	public Team(int bno, String bClass, String bTitle, String bContent, Date bDate, int bClicks, String bAttach,
	...
	public String toString() {
		return "Team [bno=" + bno + ", bClass=" + bClass + ", bTitle=" + bTitle + ", bContent=" + bContent + ", bDate="
