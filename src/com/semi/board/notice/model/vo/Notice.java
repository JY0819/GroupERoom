package com.semi.board.notice.model.vo;
...
public class Notice {
	...
	public Notice(int bno, String bClass, String bTitle, String bContent, Date bDate, int bClicks, String bAttach,
	...
	public String toString() {
		return "Notice [bno=" + bno + ", bClass=" + bClass + ", bTitle=" + bTitle + ", bContent=" + bContent
				+ ", bDate=" + bDate + ", bClicks=" + bClicks + ", bAttach=" + bAttach + ", comNo=" + comNo
				+ ", comLevel=" + comLevel + ", recomId=" + recomId + ", deptId=" + deptId + ", replebno=" + replebno
				+ ", writerId=" + writerId + ", status=" + status + ", file01=" + file01 + ", file02=" + file02
				+ ", file03=" + file03 + "]";
	}
