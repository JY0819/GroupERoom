...
/**
 * Servlet implementation class InsertNoticeFileServlet
 */
@WebServlet("/insertFile.no")
public class InsertNoticeFileServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InsertNoticeFileServlet() {
        super();
...
/*			String fileName=multiRequest.getFilesystemName("fileInput");
			...
			// 객체 생성
			Notice n = new Notice();
			n.setbTitle(multiTitle);
			n.setbContent(multiContent);			
			n.setWriterId(String.valueOf(((Employee)(request.getSession().getAttribute("loginUser"))).getEmpid()));
...
System.out.println("도니");
			...
			int result = new NoticeService().insertThumbnail(n, fileList);
