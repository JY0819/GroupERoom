...
/**
 * Servlet implementation class DownloadFreeServlet
 */
@WebServlet("/download.fr")
public class DownloadFreeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DownloadFreeServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Attachment file = new FreeService().selectOneAttachment(num);
